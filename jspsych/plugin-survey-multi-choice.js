      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: center; }" +
                //   ".jspsych-survey-multi-choice-text span.required {color: black;}" +
                  ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: center; font-size: 10pt;}" +
