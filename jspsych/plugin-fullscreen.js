    ...
    class FullscreenPlugin {
        ...
        showDisplay(display_element, trial) {
            display_element.innerHTML = `
                ${trial.message}
                <button id="jspsych-fullscreen-btn" class="jspsych-btn jspsych-center">${trial.button_label}</button>
            `;
        ...
        simulate_visual(trial, simulation_options, load_callback) {
            ...
            if (data.success === false) {
                ...
                load_callback();
                this.jsPsych.pluginAPI.clickTarget(display_element.querySelector("#jspsych-fullscreen-btn"),
